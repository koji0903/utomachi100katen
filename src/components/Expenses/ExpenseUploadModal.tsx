                        ...
                        <form onSubmit={handleSubmit} className="space-y-8">
                            ...
                            <div className="space-y-6">
                                ...
                                <div>
                                    ...
                                    <input
                                        type="text"
                                        list="upload-modal-category-options"
                                        placeholder="または任意のカテゴリーを直接入力..."
                                        value={category}
                                        onChange={(e) => setCategory(e.target.value)}
                                        className="w-full px-5 py-3.5 bg-slate-50 border border-slate-100 rounded-2xl focus:outline-none focus:ring-4 focus:ring-rose-500/10 focus:border-rose-500 transition-all text-xs font-black text-slate-800"
                                    />
                                    <datalist id="upload-modal-category-options">
                                        {CATEGORIES.map(cat => (
